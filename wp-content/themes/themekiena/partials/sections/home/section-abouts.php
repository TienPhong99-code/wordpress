...
<section class="section-abouts relative section-pd-t z-1 max-md:bg-white">
   ...
   <span class="absolute inset-0 md:bg-linear-to-b from-[#ffffff] to-[#b5eaff] z-[-1] "></span>

   <!-- Top: content group -->
   <div class="md:absolute md:top-[10%] md:left-1/2 md:-translate-x-1/2 md:w-full md:z-10">
      <div class="container">
         <div class="relative z-1">
            <div class="about-content max-w-200 mx-auto text-center">
               <span class="mx-auto mb-6 block">
                  <svg class="svg-title-about" width="795" height="165" viewBox="0 0 795 165" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                     <mask id="mask0_94_28136" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="796" height="165">
               ...
               <div class="max-w-180 mx-auto">
                  <p class="text-[16px] text-pri mb-4">
                     KIẾN Á GROUP (KAG) được thành lập <span class="c-second font-bold">năm 1994,</span> là Tập đoàn phát triển đa ngành với ba lĩnh vực trọng tâm: Bất động sản, Giáo dục, và Xây dựng - dịch vụ.
                  </p>
                  <p class="text-[16px] text-pri">
                     Tập đoàn theo đuổi <span class="c-second font-bold">triết lý phát triển bền vững:</span> lấy con người làm trung tâm, hướng đến kiến tạo các công trình và hệ sinh thái xanh có giá trị lâu dài cho cộng đồng.
                  </p>
               </div>
            </div>
         </div>
