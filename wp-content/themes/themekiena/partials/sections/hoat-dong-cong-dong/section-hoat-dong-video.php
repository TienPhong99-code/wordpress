    ...
    <div class="container">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex gap-1 shrink-0">
                <button class="tts-prev tts-btn w-11 h-11 rounded-full flex items-center justify-center shrink-0 transition" aria-label="Trước">
                ...
                <button class="tts-next tts-btn w-11 h-11 rounded-full flex items-center justify-center shrink-0 transition" aria-label="Tiếp theo">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
