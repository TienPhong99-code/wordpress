    ...
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($categories as $item) :
                $image = $item['image'] ? wp_get_attachment_image_url($item['image'], 'large') : '';
                $url   = $item['url'] ?: '#';
                ?>
                <div class="col col-6 max-md:w-full!">
                    <div class="relative flex flex-col gap-3 max-md:gap-2 items-center group">
                        ...
                        <a href="<?php echo esc_url($url); ?>" class="absolute inset-0 z-1" aria-label="<?php echo esc_attr($item['title']); ?>"></a>
